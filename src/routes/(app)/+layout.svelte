...
<svelte:head>
  ...
  <script defer
    ...
    data-token="p.eyJ1IjogImM3NjM0ODgwLTRlMGItNGE3ZC04NTE3LTk4NTRjYzdjMzg5OSIsICJpZCI6ICIwNmNiMzQ4Yy01NTdmLTQ0OGEtYjVlOC0zMjE4YTIzZDA4YjQiLCAiaG9zdCI6ICJldV9zaGFyZWQifQ.QHtmwFxBgS85i6od8LfIswz55fOTaB6TYWeOWyBdFdM"
  />
	{/if}
</svelte:head>
...
<!-- <InspectorGadget>
	<DetailsSummary style="bg-black-10" summary="SERP">
		<Serp />
	</DetailsSummary>

  <DetailsSummary style="bg-black-10" summary="NEW">
		New...
	</DetailsSummary>
...
hr{border:0;border-top:1px solid transparent;color:inherit;margin:1em 0;padding:0}
...
.aspect-ratio--3x1{padding-bottom:33.3333%}
...
.b--white-90{border-color:hsla(0,0%,100%,0.9)}
.b--white-80{border-color:hsla(0,0%,100%,0.8)}
.b--white-70{border-color:hsla(0,0%,100%,0.7)}
.b--white-60{border-color:hsla(0,0%,100%,0.6)}
.b--white-50{border-color:hsla(0,0%,100%,0.5)}
.b--white-40{border-color:hsla(0,0%,100%,0.4)}
.b--white-30{border-color:hsla(0,0%,100%,0.3)}
.b--white-20{border-color:hsla(0,0%,100%,0.2)}
.b--white-10{border-color:hsla(0,0%,100%,0.1)}
.b--white-05{border-color:hsla(0,0%,100%,0.05)}
.b--white-025{border-color:hsla(0,0%,100%,0.025)}
.b--white-0125{border-color:hsla(0,0%,100%,0.0125)}
...
.shadow-1-hover,.shadow-2-hover,.shadow-3-hover,.shadow-4-hover,.shadow-5-hover{box-shadow:0 0 0 0 rgba(0,0,0,0)}
.shadow-1{box-shadow:0 0 4px 2px rgba(0,0,0,0.2)}
.shadow-1-hover:hover{box-shadow:0 0 4px 2px rgba(0,0,0,0.2)}
.shadow-2{box-shadow:0 0 8px 2px rgba(0,0,0,0.2)}
.shadow-2-hover:hover{box-shadow:0 0 8px 2px rgba(0,0,0,0.2)}
.shadow-3{box-shadow:0 2px 4px 2px rgba(0,0,0,0.2)}
.shadow-3-hover:hover{box-shadow:0 2px 4px 2px rgba(0,0,0,0.2)}
.shadow-4{box-shadow:0 2px 8px 0 rgba(0,0,0,0.2)}
.shadow-4-hover:hover{box-shadow:0 2px 8px 0 rgba(0,0,0,0.2)}
.shadow-5{box-shadow:0 4px 8px 0 rgba(0,0,0,0.2)}
.shadow-5-hover:hover{box-shadow:0 4px 8px 0 rgba(0,0,0,0.2)}
...
.white-90{color:hsla(0,0%,100%,0.9)}
.white-80{color:hsla(0,0%,100%,0.8)}
.white-70{color:hsla(0,0%,100%,0.7)}
.white-60{color:hsla(0,0%,100%,0.6)}
.white-50{color:hsla(0,0%,100%,0.5)}
.white-40{color:hsla(0,0%,100%,0.4)}
.white-30{color:hsla(0,0%,100%,0.3)}
.white-20{color:hsla(0,0%,100%,0.2)}
.white-10{color:hsla(0,0%,100%,0.1)}
.black{color:#000}
...
.bg-white-80{background-color:hsla(0,0%,100%,0.8)}
.bg-white-70{background-color:hsla(0,0%,100%,0.7)}
.bg-white-60{background-color:hsla(0,0%,100%,0.6)}
.bg-white-50{background-color:hsla(0,0%,100%,0.5)}
.bg-white-40{background-color:hsla(0,0%,100%,0.4)}
.bg-white-30{background-color:hsla(0,0%,100%,0.3)}
...
.hover-white-90:focus,.hover-white-90:hover{color:hsla(0,0%,100%,0.9)}
.hover-white-80:focus,.hover-white-80:hover{color:hsla(0,0%,100%,0.8)}
.hover-white-70:focus,.hover-white-70:hover{color:hsla(0,0%,100%,0.7)}
.hover-white-60:focus,.hover-white-60:hover{color:hsla(0,0%,100%,0.6)}
.hover-white-50:focus,.hover-white-50:hover{color:hsla(0,0%,100%,0.5)}
.hover-white-40:focus,.hover-white-40:hover{color:hsla(0,0%,100%,0.4)}
.hover-white-30:focus,.hover-white-30:hover{color:hsla(0,0%,100%,0.3)}
.hover-white-20:focus,.hover-white-20:hover{color:hsla(0,0%,100%,0.2)}
.hover-white-10:focus,.hover-white-10:hover{color:hsla(0,0%,100%,0.1)}
...
.hover-bg-white-90:focus,.hover-bg-white-90:hover{background-color:hsla(0,0%,100%,0.9)}
.hover-bg-white-80:focus,.hover-bg-white-80:hover{background-color:hsla(0,0%,100%,0.8)}
.hover-bg-white-70:focus,.hover-bg-white-70:hover{background-color:hsla(0,0%,100%,0.7)}
.hover-bg-white-60:focus,.hover-bg-white-60:hover{background-color:hsla(0,0%,100%,0.6)}
.hover-bg-white-50:focus,.hover-bg-white-50:hover{background-color:hsla(0,0%,100%,0.5)}
.hover-bg-white-40:focus,.hover-bg-white-40:hover{background-color:hsla(0,0%,100%,0.4)}
.hover-bg-white-30:focus,.hover-bg-white-30:hover{background-color:hsla(0,0%,100%,0.3)}
.hover-bg-white-20:focus,.hover-bg-white-20:hover{background-color:hsla(0,0%,100%,0.2)}
.hover-bg-white-10:focus,.hover-bg-white-10:hover{background-color:hsla(0,0%,100%,0.1)}
...
.stripe-light:nth-child(odd){background-color:hsla(0,0%,100%,0.1)}
...
.dim{transform:translateZ(0);opacity:1}
...
.grow{-moz-osx-font-smoothing:grayscale;-webkit-backface-visibility:hidden;backface-visibility:hidden;-webkit-transform:translateZ(0);transform:translateZ(0);transition:-webkit-transform .25s ease-out;transition:transform .25s ease-out;transition:transform .25s ease-out,-webkit-transform .25s ease-out;background-clip:padding-box}
.grow:focus,.grow:hover{-webkit-transform:perspective(1px) scale(1.05);transform:perspective(1px) scale(1.05)}
.grow:active{-webkit-transform:perspective(1px) scale(0.9);transform:perspective(1px) scale(0.9)}
.grow-large{-moz-osx-font-smoothing:grayscale;-webkit-backface-visibility:hidden;backface-visibility:hidden;-webkit-transform:translateZ(0);transform:translateZ(0);transition:-webkit-transform .25s ease-in-out;transition:transform .25s ease-in-out;transition:transform .25s ease-in-out,-webkit-transform .25s ease-in-out;background-clip:padding-box}
.grow-large:focus,.grow-large:hover{-webkit-transform:perspective(1px) scale(1.2);transform:perspective(1px) scale(1.2)}
.grow-large:active{-webkit-transform:perspective(1px) scale(0.95);transform:perspective(1px) scale(0.95)}
.alias{cursor:alias}
...
.shadow-hover{position:relative;transition:all .5s cubic-bezier(0.165,0.84,0.44,1)}
...
details[open] summary ~ *{animation:fade .666s ease-in-out 0s}
@keyframes fade {
0%{opacity:0}
100%{opacity:1}
}
...
:root{--alpha:1;--one:.1;--two:.2;--three:.3;--four:.4;--five:.5;--six:.6;--seven:.7;--eight:.8;--nine:.9;--ten:1;--tint-fg:darkgrey;--tint-bg:white;--dim-cta:darkgrey;--lit-cta:gainsboro;--golden-brown:hsla(36.6,73.9%,30%,var(--alpha));--solitaire:hsla(34,47%,85%,var(--alpha));--linen:hsla(32,60%,95.1%,var(--alpha));--cocoa:hsla(30,28.95%,14.9%,var(--alpha));--charcoal:#4a4a4a;--dark-beige:rgba(234,219,160,var(--ten));--beige:rgba(244,237,207,var(--ten));--plum:#7f3c84;--tyrian:#57005d;--magnolia:#f7f5f7;--oxford:#002147;--violet:#741472;--mustard:#8a3700;--spa:#006f45;--health:#ef604d;--education:#f4ad8b;--food:#dcd7d7;--transport:#b2d9e8;--shelter:#7db6d0;--global:#c858c5;--national:#f0a1e0;--regional:#d8eeea;--institution:#9df5d2;--community:#59ce89;--skype:#00aff0;--pinterest:#e60023;--twitter:#1da1f2;--linkedin:#0073b2;--pm-blue:#657ee4;--pm-blue-dark:#526ee0;--pm-blue-light:#788ee8;--vimeo:#1eb8eb;--tripadvisor:#00a680;--facebook:#1877f2;--whatsapp:#25d366;--electric-lime:hsla(76,100%,50%,1);--caribbean:hsla(160,82%,49%,1);--meadow:hsla(158,79%,42%,1);--cobalt:hsla(201,75%,36%,1);--egyptian:hsla(231,60%,38%,1);--grape:hsla(264,84%,55%,1);--prussia:hsla(262,51%,41%,1);--raspberry:hsla(330,100%,37%,1);--mexicano:hsla(332,100%,50%,1);--pumpkin:hsla(20,90%,52%,1);--mandarino:hsla(40,100%,53%,1);--soccorso:hsla(48,100%,50%,1)}
.pumpkin{color:var(--pumpkin);fill:var(--pumpkin)}
.bg-pumpkin{background-color:var(--pumpkin)}
.b--pumpkin{border-color:var(--pumpkin)}
.hover-pumpkin:hover,.hover-pumpkin:focus{color:var(--pumpkin)}
.hover-bg-pumpkin:hover,.hover-bg-pumpkin:focus{background-color:var(--pumpkin)}
.soccorso{color:var(--soccorso);fill:var(--soccorso)}
.bg-soccorso{background-color:var(--soccorso)}
.b--soccorso{border-color:var(--soccorso)}
.hover-soccorso:hover,.hover-soccorso:focus{color:var(--soccorso)}
.hover-bg-soccorso:hover,.hover-bg-soccorso:focus{background-color:var(--soccorso)}
.mandarino{color:var(--mandarino);fill:var(--mandarino)}
.bg-mandarino{background-color:var(--mandarino)}
.b--mandarino{border-color:var(--mandarino)}
.hover-mandarino:hover,.hover-mandarino:focus{color:var(--mandarino)}
.hover-bg-mandarino:hover,.hover-bg-mandarino:focus{background-color:var(--mandarino)}
.egyptian{color:var(--egyptian);fill:var(--egyptian)}
.bg-egyptian{background-color:var(--egyptian)}
.b--egyptian{border-color:var(--egyptian)}
.hover-egyptian:hover,.hover-egyptian:focus{color:var(--egyptian)}
.hover-bg-egyptian:hover,.hover-bg-egyptian:focus{background-color:var(--egyptian)}
.grape{color:var(--grape);fill:var(--grape)}
.bg-grape{background-color:var(--grape)}
.b--grape{border-color:var(--grape)}
.hover-grape:hover,.hover-grape:focus{color:var(--grape)}
.hover-bg-grape:hover,.hover-bg-grape:focus{background-color:var(--grape)}
.electric-lime{color:var(--electric-lime);fill:var(--electric-lime)}
.bg-electric-lime{background-color:var(--electric-lime)}
.b--electric-lime{border-color:var(--electric-lime)}
.hover-electric-lime:hover,.hover-electric-lime:focus{color:var(--electric-lime)}
.hover-bg-electric-lime:hover,.hover-bg-electric-lime:focus{background-color:var(--electric-lime)}
.raspberry{color:var(--raspberry);fill:var(--raspberry)}
.bg-raspberry{background-color:var(--raspberry)}
.b--raspberry{border-color:var(--raspberry)}
.hover-raspberry:hover,.hover-raspberry:focus{color:var(--raspberry)}
.hover-bg-raspberry:hover,.hover-bg-raspberry:focus{background-color:var(--raspberry)}
.cobalt{color:var(--cobalt);fill:var(--cobalt)}
.bg-cobalt{background-color:var(--cobalt)}
.b--cobalt{border-color:var(--cobalt)}
.hover-cobalt:hover,.hover-cobalt:focus{color:var(--cobalt)}
.hover-bg-cobalt:hover,.hover-bg-cobalt:focus{background-color:var(--cobalt)}
.prussia{color:var(--prussia);fill:var(--prussia)}
.bg-prussia{background-color:var(--prussia)}
.b--prussia{border-color:var(--prussia)}
.hover-prussia:hover,.hover-prussia:focus{color:var(--prussia)}
.hover-bg-prussia:hover,.hover-bg-prussia:focus{background-color:var(--prussia)}
.caribbean{color:var(--caribbean);fill:var(--caribbean)}
.bg-caribbean{background-color:var(--caribbean)}
.b--caribbean{border-color:var(--caribbean)}
.hover-caribbean:hover,.hover-caribbean:focus{color:var(--caribbean)}
.hover-bg-caribbean:hover,.hover-bg-caribbean:focus{background-color:var(--caribbean)}
.meadow{color:var(--meadow);fill:var(--meadow)}
.bg-meadow{background-color:var(--meadow)}
.b--meadow{border-color:var(--meadow)}
.hover-meadow:hover,.hover-meadow:focus{color:var(--meadow)}
.hover-bg-meadow:hover,.hover-bg-meadow:focus{background-color:var(--meadow)}
.mexicano{color:var(--mexicano);fill:var(--mexicano)}
.bg-mexicano{background-color:var(--mexicano)}
.b--mexicano{border-color:var(--mexicano)}
.hover-mexicano:hover,.hover-mexicano:focus{color:var(--mexicano)}
.hover-bg-mexicano:hover,.hover-bg-mexicano:focus{background-color:var(--mexicano)}
.skype{color:var(--skype);fill:var(--skype)}
.bg-skype{background-color:var(--skype)}
.b--skype{border-color:var(--skype)}
.hover-skype:hover,.hover-skype:focus{color:var(--skype)}
.hover-bg-skype:hover,.hover-bg-skype:focus{background-color:var(--skype)}
.pinterest{color:var(--pinterest);fill:var(--pinterest)}
.bg-pinterest{background-color:var(--pinterest)}
.b--pinterest{border-color:var(--pinterest)}
.hover-pinterest:hover,.hover-pinterest:focus{color:var(--pinterest)}
.hover-bg-pinterest:hover,.hover-bg-pinterest:focus{background-color:var(--pinterest)}
.twitter{color:var(--twitter);fill:var(--twitter)}
.bg-twitter{background-color:var(--twitter)}
.b--twitter{border-color:var(--twitter)}
.hover-twitter:hover,.hover-twitter:focus{color:var(--twitter)}
.hover-bg-twitter:hover,.hover-bg-twitter:focus{background-color:var(--twitter)}
.linkedin{color:var(--linkedin);fill:var(--linkedin)}
.bg-linkedin{background-color:var(--linkedin)}
.b--linkedin{border-color:var(--linkedin)}
.hover-linkedin:hover,.hover-linkedin:focus{color:var(--linkedin)}
.hover-bg-linkedin:hover,.hover-bg-linkedin:focus{background-color:var(--linkedin)}
.facebook{color:var(--facebook);fill:var(--facebook)}
.bg-facebook{background-color:var(--facebook)}
.b--facebook{border-color:var(--facebook)}
.hover-facebook:hover,.hover-facebook:focus{color:var(--facebook)}
.hover-bg-facebook:hover,.hover-bg-facebook:focus{background-color:var(--facebook)}
.pm-blue{color:var(--pm-blue);fill:var(--pm-blue)}
.bg-pm-blue{background-color:var(--pm-blue)}
.b--pm-blue{border-color:var(--pm-blue)}
.hover-pm-blue:hover,.hover-pm-blue:focus{color:var(--pm-blue)}
.hover-bg-pm-blue:hover,.hover-bg-pm-blue:focus{background-color:var(--pm-blue)}
.pm-blue-dark{color:var(--pm-blue-dark);fill:var(--pm-blue-dark)}
.bg-pm-blue-dark{background-color:var(--pm-blue-dark)}
.b--pm-blue-dark{border-color:var(--pm-blue-dark)}
.hover-pm-blue-dark:hover,.hover-pm-blue-dark:focus{color:var(--pm-blue-dark)}
.hover-bg-pm-blue-dark:hover,.hover-bg-pm-blue-dark:focus{background-color:var(--pm-blue-dark)}
.pm-blue-light{color:var(--pm-blue-light);fill:var(--pm-blue-light)}
.bg-pm-blue-light{background-color:var(--pm-blue-light)}
.b--pm-blue-light{border-color:var(--pm-blue-light)}
.hover-pm-blue-light:hover,.hover-pm-blue-light:focus{color:var(--pm-blue-light)}
.hover-bg-pm-blue-light:hover,.hover-bg-pm-blue-light:focus{background-color:var(--pm-blue-light)}
.vimeo{color:var(--vimeo);fill:var(--vimeo)}
.bg-vimeo{background-color:var(--vimeo)}
.b--vimeo{border-color:var(--vimeo)}
.hover-vimeo:hover,.hover-vimeo:focus{color:var(--vimeo)}
.hover-bg-vimeo:hover,.hover-bg-vimeo:focus{background-color:var(--vimeo)}
.tripadvisor{color:var(--tripadvisor);fill:var(--tripadvisor)}
.bg-tripadvisor{background-color:var(--tripadvisor)}
.b--tripadvisor{border-color:var(--tripadvisor)}
.hover-tripadvisor:hover,.hover-tripadvisor:focus{color:var(--tripadvisor)}
.hover-bg-tripadvisor:hover,.hover-bg-tripadvisor:focus{background-color:var(--tripadvisor)}
.whatsapp{color:var(--whatsapp);fill:var(--whatsapp)}
.bg-whatsapp{background-color:var(--whatsapp)}
.b--whatsapp{border-color:var(--whatsapp)}
.hover-whatsapp:hover,.hover-whatsapp:focus{color:var(--whatsapp)}
.hover-bg-whatsapp:hover,.hover-bg-whatsapp:focus{background-color:var(--whatsapp)}
.tint-bg{background-color:var(--tint-bg)}
...
.h07{height:.7rem}
.golden-brown{color:var(--golden-brown);fill:var(--golden-brown)}
.hover-golden-brown:active,.hover-golden-brown:hover,.hover-golden-brown:focus{color:var(--golden-brown);fill:var(--golden-brown)}
.bg-golden-brown{background-color:var(--golden-brown)}
.b--golden-brown{border-color:var(--golden-brown)}
.hover-bg-golden-brown:active,.hover-bg-golden-brown:hover,.hover-bg-golden-brown:focus{background-color:var(--golden-brown)}
.solitaire{color:var(--solitaire);fill:var(--solitaire)}
.hover-solitaire:active,.hover-solitaire:hover,.hover-solitaire:focus{color:var(--solitaire);fill:var(--solitaire)}
.bg-solitaire{background-color:var(--solitaire)}
.b--solitaire{border-color:var(--solitaire)}
.hover-bg-solitaire:active,.hover-bg-solitaire:hover,.hover-bg-solitaire:focus{background-color:var(--solitaire)}
.linen{color:var(--linen);fill:var(--linen)}
.hover-linen:active,.hover-linen:hover,.hover-linen:focus{color:var(--linen);fill:var(--linen)}
.bg-linen{background-color:var(--linen)}
.b--linen{border-color:var(--linen)}
.hover-bg-linen:active,.hover-bg-linen:hover,.hover-bg-linen:focus{background-color:var(--linen)}
.cocoa{color:var(--cocoa);fill:var(--cocoa)}
.hover-cocoa:active,.hover-cocoa:hover,.hover-cocoa:focus{color:var(--cocoa);fill:var(--cocoa)}
.bg-cocoa{background-color:var(--cocoa)}
.b--cocoa{border-color:var(--cocoa)}
.hover-bg-cocoa:active,.hover-bg-cocoa:hover,.hover-bg-cocoa:focus{background-color:var(--cocoa)}
.beige{color:var(--beige)}
.bg-beige{background-color:var(--beige)}
.b--beige{border-color:var(--beige)}
.hover-beige:hover,.hover-beige:focus{color:var(--beige)}
.hover-bg-beige:hover,.hover-bg-beige:focus{background-color:var(--beige)}
.dark-beige{color:var(--dark-beige)}
.bg-dark-beige{background-color:var(--dark-beige)}
.b--dark-beige{border-color:var(--dark-beige)}
.hover-dark-beige:hover,.hover-dark-beige:focus{color:var(--dark-beige)}
.hover-bg-dark-beige:hover,.hover-bg-dark-beige:focus{background-color:var(--dark-beige)}
.dim-gray{color:#444}
.bg-dim-gray{background-color:#444}
.b--dim-gray{border-color:#444}
.hover-dim-gray:hover,.hover-dim-gray:focus{color:#444}
.hover-bg-dim-gray:hover,.hover-bg-dim-gray:focus{background-color:#444}
.off-white{color:#ddd}
.bg-off-white{background-color:#ddd}
.b--off-white{border-color:#ddd}
.hover-off-white:hover,.hover-off-white:focus{color:#ddd}
.hover-bg-off-white:hover,.hover-bg-off-white:focus{background-color:#ddd}
.charcoal{color:var(--charcoal)}
.bg-charcoal{background-color:var(--charcoal)}
.b--charcoal{border-color:var(--charcoal)}
.hover-charcoal:hover,.hover-charcoal:focus{color:var(--charcoal)}
.hover-bg-charcoal:hover,.hover-bg-charcoal:focus{background-color:var(--charcoal)}
.magnolia{color:var(--magnolia)}
.bg-magnolia{background-color:var(--magnolia)}
.b--magnolia{border-color:var(--magnolia)}
.hover-magnolia:hover,.hover-magnolia:focus{color:var(--magnolia)}
.hover-bg-magnolia:hover,.hover-bg-magnolia:focus{background-color:var(--magnolia)}
.tyrian{color:var(--tyrian)}
.bg-tyrian{background-color:var(--tyrian)}
.b--tyrian{border-color:var(--tyrian)}
.hover-tyrian:hover,.hover-tyrian:focus{color:var(--tyrian)}
.hover-bg-tyrian:hover,.hover-bg-tyrian:focus{background-color:var(--tyrian)}
.plum{color:var(--plum)}
.bg-plum{background-color:var(--plum)}
.b--plum{border-color:var(--plum)}
.hover-plum:hover,.hover-plum:focus{color:var(--plum)}
.hover-bg-plum:hover,.hover-bg-plum:focus{background-color:var(--plum)}
.beacon{color:#f15a22}
.bg-beacon{background-color:#f15a22}
.b--beacon{border-color:#f15a22}
.hover-beacon:hover,.hover-beacon:focus{color:#f15a22}
.hover-bg-beacon:hover,.hover-bg-beacon:focus{background-color:#f15a22}
.mustard{color:var(--mustard)}
.bg-mustard{background-color:var(--mustard)}
.b--mustard{border-color:var(--mustard)}
.hover-mustard:hover,.hover-mustard:focus{color:var(--mustard)}
.hover-bg-mustard:hover,.hover-bg-mustard:focus{background-color:var(--mustard)}
.spa{color:var(--spa)}
.bg-spa{background-color:var(--spa)}
.b--spa{border-color:var(--spa)}
.hover-spa:hover,.hover-spa:focus{color:var(--spa)}
.hover-bg-spa:hover,.hover-bg-spa:focus{background-color:var(--spa)}
.violet{color:var(--violet)}
.bg-violet{background-color:var(--violet)}
.b--violet{border-color:var(--violet)}
.hover-violet:hover,.hover-violet:focus{color:var(--violet)}
.hover-bg-violet:hover,.hover-bg-violet:focus{background-color:var(--violet)}
.oxford{color:var(--oxford)}
.bg-oxford{background-color:var(--oxford)}
.b--oxford{border-color:var(--oxford)}
.hover-oxford:hover,.hover-oxford:focus{color:var(--oxford)}
.hover-bg-oxford:hover,.hover-bg-oxford:focus{background-color:var(--oxford)}
.beige{color:var(--beige)}
.bg-beige{background-color:var(--beige)}
.b--beige{border-color:var(--beige)}
.hover-beige:hover,.hover-beige:focus{color:var(--beige)}
...
.hover-dark-beige:hover,.hover-dark-beige:focus{color:var(--dark-beige)}
.hover-bg-dark-beige:hover,.hover-bg-dark-beige:focus{background-color:var(--dark-beige)}
.dark-lime{color:#66a61e}
.bg-dark-lime{background-color:#66a61e}
.b--dark-lime{border-color:#66a61e}
.hover-dark-lime:hover,.hover-dark-lime:focus{color:#66a61e}
.hover-bg-dark-lime:hover,.hover-bg-dark-lime:focus{background-color:#66a61e}
.lilac-flower{color:#7570b3}
.bg-lilac-flower{background-color:#7570b3}
.b--lilac-flower{border-color:#7570b3}
.hover-lilac-flower:hover,.hover-lilac-flower:focus{color:#7570b3}
.hover-bg-lilac-flower:hover,.hover-bg-lilac-flower:focus{background-color:#7570b3}
.jade{color:#1b9e77}
.bg-jade{background-color:#1b9e77}
.b--jade{border-color:#1b9e77}
.hover-jade:hover,.hover-jade:focus{color:#1b9e77}
.hover-bg-jade:hover,.hover-bg-jade:focus{background-color:#1b9e77}
.disco-pink{color:#e7298a}
.bg-disco-pink{background-color:#e7298a}
.b--disco-pink{border-color:#e7298a}
.hover-disco-pink:hover,.hover-disco-pink:focus{color:#e7298a}
.hover-bg-disco-pink:hover,.hover-bg-disco-pink:focus{background-color:#e7298a}
.health{color:var(--health)}
.bg-health{background-color:var(--health)}
.b--health{border-color:var(--health)}
.hover-health:hover,.hover-health:focus{color:var(--health)}
.hover-bg-health:hover,.hover-bg-health:focus{background-color:var(--health)}
.education{color:var(--education)}
.bg-education{background-color:var(--education)}
.b--education{border-color:var(--education)}
.hover-education:hover,.hover-education:focus{color:var(--education)}
.hover-bg-education:hover,.hover-bg-education:focus{background-color:var(--education)}
.food{color:var(--food)}
.bg-food{background-color:var(--food)}
.b--food{border-color:var(--food)}
.hover-food:hover,.hover-food:focus{color:var(--food)}
.hover-bg-food:hover,.hover-bg-food:focus{background-color:var(--food)}
.transport{color:var(--transport)}
.bg-transport{background-color:var(--transport)}
.b--transport{border-color:var(--transport)}
.hover-transport:hover,.hover-transport:focus{color:var(--transport)}
.hover-bg-transport:hover,.hover-bg-transport:focus{background-color:var(--transport)}
.shelter{color:var(--shelter)}
.bg-shelter{background-color:var(--shelter)}
.b--shelter{border-color:var(--shelter)}
.hover-shelter:hover,.hover-shelter:focus{color:var(--shelter)}
.hover-bg-shelter:hover,.hover-bg-shelter:focus{background-color:var(--shelter)}
.global{color:var(--global)}
.bg-global{background-color:var(--global)}
.b--global{border-color:var(--global)}
.hover-global:hover,.hover-global:focus{color:var(--global)}
.hover-bg-global:hover,.hover-bg-global:focus{background-color:var(--global)}
.national{color:var(--national)}
...
.regional{color:var(--regional)}
.bg-regional{background-color:var(--regional)}
.b--regional{border-color:var(--regional)}
.hover-regional:hover,.hover-regional:focus{color:var(--regional)}
.hover-bg-regional:hover,.hover-bg-regional:focus{background-color:var(--regional)}
.institution{color:var(--institution)}
.bg-institution{background-color:var(--institution)}
.b--institution{border-color:var(--institution)}
.hover-institution:hover,.hover-institution:focus{color:var(--institution)}
.hover-bg-institution:hover,.hover-bg-institution:focus{background-color:var(--institution)}
.community{color:var(--community)}
.bg-community{background-color:var(--community)}
.b--community{border-color:var(--community)}
.hover-community:hover,.hover-community:focus{color:var(--community)}
.hover-bg-community:hover,.hover-bg-community:focus{background-color:var(--community)}
.large{font-size:100%}
.v-sup{vertical-align:-.3em}
details * a{color:inherit;cursor:pointer}details * a:hover{color:inherit}
code{-webkit-overflow-scrolling:touch;overflow:scroll;overflow-wrap:break-word;word-wrap:break-word;-ms-word-break:break-all;word-break:break-word}
.blockquote{font-family:"baskerville","serif";font-size:124%;font-style:italic;padding:1em 0 1rem;margin:0;opacity:1;display:block;width:100%;letter-spacing:-.025em;font-weight:600;opacity:.9}
.blockquote p{padding-right:.2rem}
.blockquote a{opacity:.8}
.helvetica-neue{font-family:"Helvetica Neue",HelveticaNeue,"TeX Gyre Heros",TeXGyreHeros,FreeSans,"Nimbus Sans L","Liberation Sans",Arimo,Helvetica,Arial,sans-serif}
.post-holder ul{padding-left:0}
.post-holder ul li ul li{margin-left:1rem}
.post-holder * a{color:rgba(166,166,166,1)}
.post-holder * a:focus,.post-holder * a:hover{color:rgba(166,166,166,0.8);transition:color .15s ease-in}
.transition{transition:all .4s ease 0s;-webkit-transition:all .4s ease 0s;-webkit-font-smoothing:antialiased}
.transition:hover{transition:all .4s ease 0s;-webkit-transition:all .4s ease 0s}
html{overflow-y:auto}
#scrollspy li a{text-decoration:none}
#scrollspy li.active > a{opacity:1}
#scrollspy > .active *{clip-path:none;clip:inherit;height:auto;overflow:inherit;position:relative;white-space:nowrap;width:auto}
#menu ul ul > li{clip-path:inset(100%);clip:rect(1px,1px,1px,1px);height:1px;overflow:hidden;position:absolute;white-space:nowrap;width:1px}
*{-webkit-tap-highlight-color:rgba(0,0,0,0);-webkit-tap-highlight-color:transparent}
.backface-hidden{-webkit-backface-visibility:hidden;backface-visibility:hidden}
svg{-webkit-transform:translate3d(0,0,0)}
.system{font-family:-apple-system,BlinkMacSystemFont,avenir next,avenir,helvetica neue,helvetica,ubuntu,roboto,noto,segoe ui,arial,sans-serif}
.no-select{pointer-events:none;-ms-touch-action:none;-webkit-touch-callout:none;-webkit-user-select:none;-khtml-user-select:none;-moz-user-select:none;-o-user-select:none;user-select:none}
.no-clutter{-webkit-user-select:none;-khtml-user-select:none;-moz-user-select:none;-o-user-select:none;user-select:none;-webkit-tap-highlight-color:rgba(0,0,0,0);-webkit-tap-highlight-color:transparent;-webkit-touch-callout:none;-webkit-text-size-adjust:none}
.no-focus-ring:focus{outline:none}
.no-focus-ring::-moz-focus-inner{border:0}
.antialias{-webkit-font-smoothing:antialiased;-moz-osx-font-smoothing:grayscale}
.smooth-scroll{scroll-behavior:smooth}
.touch-scrolling{overflow-y:scroll;-webkit-overflow-scrolling:touch}
.touch-manipulation{-ms-touch-action:manipulation;touch-action:manipulation}
*,:focus,:focus:not(.focus-visible){box-shadow:0 0 0 0 #808080}
.restyle{box-shadow:0 0 0 0 transparent!important}
.focus-visible{box-shadow:0 0 0 1rem transparent;transition:box-shadow .3s ease;transition-delay:.125s}
.retry{animation:RETRY .5s linear;-webkit-animation:RETRY .5s linear}
@keyframes RETRY {
...
.thick-underline{border-bottom:2px solid transparent;transition:.6s cubic-bezier(0.088,0,0.62,1) border-bottom}
.thick-underline:focus{border-bottom:2px solid white}
.input-reset{line-height:initial}
input::-webkit-input-placeholder  {color:inherit;opacity:0.333}
input::-ms-input-placeholder  {color:inherit;opacity:0.333}
input:-ms-input-placeholder  {color:inherit;opacity:0.333}
input::placeholder  {color:inherit;opacity:0.333}
input:focus::placeholder {opacity: 0.2}
.select-reset{display:inline-block;width:100%;min-width:5rem;background-image:url(data:image/svg+xml;charset=utf-8,%3Csvg%20version%3D%221.1%22%20xmlns%3D%22http%3A%2F%2Fwww.w3.org%2F2000%2Fsvg%22%20xmlns%3Axlink%3D%22http%3A%2F%2Fwww.w3.org%2F1999%2Fxlink%22%20x%3D%220px%22%20y%3D%220px%22%20fill%3D%22%23555555%22%20%0A%09%20width%3D%2224px%22%20height%3D%2224px%22%20viewBox%3D%22-261%20145.2%2024%2024%22%20style%3D%22enable-background%3Anew%20-261%20145.2%2024%2024%3B%22%20xml%3Aspace%3D%22preserve%22%3E%0A%3Cpath%20d%3D%22M-245.3%2C156.1l-3.6-6.5l-3.7%2C6.5%20M-252.7%2C159l3.7%2C6.5l3.6-6.5%22%2F%3E%0A%3C%2Fsvg%3E);background-repeat:no-repeat;background-position:right center;cursor:pointer;outline:0;border:0;border-radius:0;-webkit-appearance:none;-moz-appearance:none;appearance:none}
[role="tablist"] [aria-selected],[role="tabpanel"]{background:var(--charcoal);color:hsla(0,0%,100%,1)}
.deep-petrol{color:#2f3b53}
.bg-deep-petrol{background-color:#2f3b53}
.b--deep-petrol{border-color:#2f3b53}
.hover-deep-petrol:hover,.hover-deep-petrol:focus{color:#2f3b53}
.hover-bg-deep-petrol:hover,.hover-bg-deep-petrol:focus{background-color:#2f3b53}
.petrol{color:#445576}
.bg-petrol{background-color:#445576}
.b--petrol{border-color:#445576}
.hover-petrol:hover,.hover-petrol:focus{color:#445576}
.hover-bg-petrol:hover,.hover-bg-petrol:focus{background-color:#445576}
#menu nav{-webkit-transition:transform .3s cubic-bezier(0.3,0,0.02,1);-moz-transition:transform .3s cubic-bezier(0.3,0,0.02,1);-o-transition:transform .3s cubic-bezier(0.3,0,0.02,1);transition:transform .3s cubic-bezier(0.3,0,0.02,1)}
[aria-expanded="false"] ~ #menu nav{-webkit-transform:translateX(100%);transform:translateX(100%)}
[aria-expanded="true"] ~ #menu nav{-webkit-transform:translateX(0);transform:translateX(0)}
#menu .overlay{-webkit-transition:opacity .3s ease;-moz-transition:opacity .3s ease;-o-transition:opacity .3s ease;transition:opacity .3s ease}
[aria-expanded="false"] ~ #menu .overlay{opacity:0}
[aria-expanded="true"] ~ #menu .overlay{opacity:1}
@media screen and (min-width: 30em) {
.overlay{display:none}
}
.no-body-scroll{height:100%;overflow:hidden;width:100%;position:fixed}
.ts1-white{text-shadow:0 .125rem .125rem white}
@media screen and (min-width: 30em) {
.ts1-white-ns{text-shadow:0 .125rem .125rem white}
}
@media screen and (min-width: 30em) and (max-width: 60em) {
.ts1-white-m{text-shadow:0 .125rem .125rem white}
}
@media screen and (min-width: 60em) {
.ts1-white-l{text-shadow:0 .125rem .125rem white}
}
.ds1-white{filter:drop-shadow(0px 0.125rem 0.125rem white)}
@media screen and (min-width: 30em) {
.ds1-white-ns{filter:drop-shadow(0px 0.125rem 0.125rem white)}
}
@media screen and (min-width: 30em) and (max-width: 60em) {
.ds1-white-m{filter:drop-shadow(0px 0.125rem 0.125rem white)}
}
@media screen and (min-width: 60em) {
.ds1-white-l{filter:drop-shadow(0px 0.125rem 0.125rem white)}
}
.ts2-white{text-shadow:0 .625rem .625rem white}
@media screen and (min-width: 30em) {
.ts2-white-ns{text-shadow:0 .625rem .625rem white}
}
@media screen and (min-width: 30em) and (max-width: 60em) {
.ts2-white-m{text-shadow:0 .625rem .625rem white}
}
@media screen and (min-width: 60em) {
.ts2-white-l{text-shadow:0 .625rem .625rem white}
}
.ds2-white{filter:drop-shadow(0px 0.625rem 0.625rem white)}
@media screen and (min-width: 30em) {
.ds2-white-ns{filter:drop-shadow(0px 0.625rem 0.625rem white)}
}
@media screen and (min-width: 30em) and (max-width: 60em) {
.ds2-white-m{filter:drop-shadow(0px 0.625rem 0.625rem white)}
}
@media screen and (min-width: 60em) {
.ds2-white-l{filter:drop-shadow(0px 0.625rem 0.625rem white)}
}
.ts1-dark-gray{text-shadow:0 .125rem .125rem #333}
@media screen and (min-width: 30em) {
.ts1-dark-gray-ns{text-shadow:0 .125rem .125rem #333}
}
@media screen and (min-width: 30em) and (max-width: 60em) {
.ts1-dark-gray-m{text-shadow:0 .125rem .125rem #333}
}
@media screen and (min-width: 60em) {
.ts1-dark-gray-l{text-shadow:0 .125rem .125rem #333}
}
.ds1-dark-gray{filter:drop-shadow(0px 0.125rem 0.125rem #333)}
@media screen and (min-width: 30em) {
.ds1-dark-gray-ns{filter:drop-shadow(0px 0.125rem 0.125rem #333)}
}
@media screen and (min-width: 30em) and (max-width: 60em) {
.ds1-dark-gray-m{filter:drop-shadow(0px 0.125rem 0.125rem #333)}
}
@media screen and (min-width: 60em) {
.ds1-dark-gray-l{filter:drop-shadow(0px 0.125rem 0.125rem #333)}
}
.ts2-dark-gray{text-shadow:0 .625rem .625rem #333}
@media screen and (min-width: 30em) {
.ts2-dark-gray-ns{text-shadow:0 .625rem .625rem #333}
}
@media screen and (min-width: 30em) and (max-width: 60em) {
.ts2-dark-gray-m{text-shadow:0 .625rem .625rem #333}
}
@media screen and (min-width: 60em) {
.ts2-dark-gray-l{text-shadow:0 .625rem .625rem #333}
}
.ds2-dark-gray{filter:drop-shadow(0px 0.625rem 0.625rem #333)}
@media screen and (min-width: 30em) {
.ds2-dark-gray-ns{filter:drop-shadow(0px 0.625rem 0.625rem #333)}
}
@media screen and (min-width: 30em) and (max-width: 60em) {
.ds2-dark-gray-m{filter:drop-shadow(0px 0.625rem 0.625rem #333)}
}
@media screen and (min-width: 60em) {
.ds2-dark-gray-l{filter:drop-shadow(0px 0.625rem 0.625rem #333)}
}
@media all and (orientation: portrait) {
.portrait-top-0{top:0}
@media screen and (min-width: 30em) {
.portrait-top-0-ns{top:0}
}
@media screen and (min-width: 30em) and (max-width: 60em) {
.portrait-top-0-m{top:0}
}
@media screen and (min-width: 60em) {
.portrait-top-0-l{top:0}
}
.portrait-bottom-0{bottom:0}
.portrait-vh-50{height:50vh}
.portrait-vh-66{height:66vh}
.portrait-vh-85{height:85vh}
@media screen and (min-width: 30em) {
.portrait-vh-50-ns{height:50vh}
}
@media screen and (min-width: 30em) and (max-width: 60em) {
.portrait-vh-50-m{height:50vh}
}
@media screen and (min-width: 60em) {
.portrait-vh-50-l{height:50vh}
}
@media screen and (min-width: 30em) {
.portrait-vh-66-ns{height:66vh}
}
@media screen and (min-width: 30em) and (max-width: 60em) {
.portrait-vh-66-m{height:66vh}
}
@media screen and (min-width: 60em) {
.portrait-vh-66-l{height:66vh}
}
@media screen and (min-width: 30em) {
.portrait-vh-85-ns{height:85vh}
}
@media screen and (min-width: 30em) and (max-width: 60em) {
.portrait-vh-85-m{height:85vh}
}
@media screen and (min-width: 60em) {
.portrait-vh-85-l{height:85vh}
}
@media screen and (min-width: 30em) {
.portrait-bottom-0-ns{bottom:0}
}
@media screen and (min-width: 30em) and (max-width: 60em) {
.portrait-bottom-0-m{bottom:0}
}
@media screen and (min-width: 60em) {
.portrait-bottom-0-l{bottom:0}
}

}
@media all and (orientation: landscape) {
.landscape-top-0{top:0}
@media screen and (min-width: 30em) {
.landscape-top-0-ns{top:0}
}
@media screen and (min-width: 30em) and (max-width: 60em) {
.landscape-top-0-m{top:0}
}
@media screen and (min-width: 60em) {
.landscape-top-0-l{top:0}
}
.landscape-bottom-0{bottom:0}
.landscape-vh-50{height:50vh}
.landscape-vh-66{height:66vh}
.landscape-vh-85{height:85vh}
@media screen and (min-width: 30em) {
.landscape-bottom-0-ns{bottom:0}
}
@media screen and (min-width: 30em) and (max-width: 60em) {
.landscape-bottom-0-m{bottom:0}
}
@media screen and (min-width: 60em) {
.landscape-bottom-0-l{bottom:0}
}
@media screen and (min-width: 30em) {
.landscape-vh-50-ns{height:50vh}
}
@media screen and (min-width: 30em) and (max-width: 60em) {
.landscape-vh-50-m{height:50vh}
}
@media screen and (min-width: 60em) {
.landscape-vh-50-l{height:50vh}
}
@media screen and (min-width: 30em) {
.landscape-vh-66-ns{height:66vh}
}
@media screen and (min-width: 30em) and (max-width: 60em) {
.landscape-vh-66-m{height:66vh}
}
@media screen and (min-width: 60em) {
.landscape-vh-66-l{height:66vh}
}
@media screen and (min-width: 30em) {
.landscape-vh-85-ns{height:85vh}
}
@media screen and (min-width: 30em) and (max-width: 60em) {
.landscape-vh-85-m{height:85vh}
}
@media screen and (min-width: 60em) {
.landscape-vh-85-l{height:85vh}
}
...
@media screen and (min-width: 30em) {
.tracked-none-ns{letter-spacing:0}
}
@media screen and (min-width: 30em) and (max-width: 60em) {
.tracked-none-m{letter-spacing:0}
}
@media screen and (min-width: 60em) {
.tracked-none-l{letter-spacing:0}
}
.hover-o-100:hover{opacity:1;transition:all .25s ease}
@media screen and (min-width: 30em) {
.hover-o-100-ns:hover{opacity:1;transition:all .25s ease}
}
@media screen and (min-width: 30em) and (max-width: 60em) {
.hover-o-100-m:hover{opacity:1;transition:all .25s ease}
}
@media screen and (min-width: 60em) {
.hover-o-100-l:hover{opacity:1;transition:all .25s ease}
}
.lh-extended{line-height:1.953;line-height:.1}
@media screen and (min-width: 30em) {
.lh-extended-ns{line-height:1.953}
}
@media screen and (min-width: 30em) and (max-width: 60em) {
.lh-extended-m{line-height:1.953}
}
@media screen and (min-width: 60em) {
.lh-extended-l{line-height:1.953}
}
@media (min-height: 10em) and (max-height: 12em) {
.lh-extended{line-height:.5}
}
@media (min-height: 12em) and (max-height: 999em) {
.lh-extended{line-height:1.953}
}
.inherit{color:inherit;fill:currentColor}
.bg-inherit{background-color:inherit}
.fs-initial{font-style:initial}
@media screen and (min-width: 30em) {
.fs-initial-ns{font-style:initial}
}
@media screen and (min-width: 30em) and (max-width: 60em) {
.fs-initial-m{font-style:initial}
}
@media screen and (min-width: 60em) {
.fs-initial-l{font-style:initial}
}
.lh-0{line-height:0}
...
.back.emojisymbol:before{content:"\21A9"}
.link.emojisymbol:before{content:"\1F517"}
.phone.emojisymbol:before{content:"\2706"}
.mail.emojisymbol:before{content:"\1F582"}
.important.emojisymbol:before{content:"\27BD"}
.alert.emojisymbol:before{content:"\26A0"}
.emojisymbol:before{font-family:sans-serif,emojisymbols} /* cssportal.com/css-optimize */

/* note: not *yet* part of Tachyons Shower: tachyons-tldr.vercel.app/#/scales#Widths */
/* note: specify row & column: css-tricks.com/almanac/properties/g/gap/ */
/* from: https://github.com/bobek-balinek/tachyons-grid-layout/blob/master/css/tachyons-grid-layout.css */
...
/* learn: <link rel="preload" href="https://inspiredlabs.co.uk/css/SourceSans3VF-Roman.ttf.woff2" as="font" type="font/woff2" crossorigin> */
@font-face {
  src: url('https://inspiredlabs.co.uk/css/SourceSans3VF-Roman.ttf.woff2') format('woff2-variations');
  font-family:'Source Sans Variable';
  font-style: normal;
  font-weight: 100 900;
  /* font-display: auto; /* swap with FOUT */
  font-display: block; /* hide first */
  /* font-display: fallback;  stay consistent */
  /* font-display: optional; /* abort if slow */
  /* learn: iainbean.com/posts/2021/5-steps-to-faster-web-fonts/ */
}

.source-sans {
  font-family: 'Source Sans Variable', sans-serif; /* Variable */
}

/* note: rethink font weights, no thanks?! */
.source_sans_prolight { font-weight: 100 }
.source_sans_proregular { font-weight: 300 }
.source_sans_prosemibold { font-weight: 500 }
.source_sans_probold { font-weight: 800 }
...
:root {
  --primary-back: #381c75;
  --primary-back: hsla(259,61%,28%, 1);
  --primary-fore: #f3f3f3;
  --primary-fore: hsla(0,0%,95%, 1);
  --secondary-back: #211046;
  --secondary-back: hsl(259,63%,17%, 1);
  --secondary-fore: #785463;
  --secondary-fore: hsla(335,18%,40%, 1);
  --accent: #383838;
}
...
.bg-secondary-back,
.hover-bg-secondary-fore:hover,
.hover-bg-secondary-fore:focus {
...
.b--secondary-fore {
  border-color: var(--secondary-fore);
}
...
.bg-transition:hover, .bg-transition:active {
  transition: background-color 0.4s ease 0s;
  -webkit-transition: background-color 0.4s ease 0s;
}

/************ ADD INTO TACHYON-SHOWER **************/

/* Optimal reading length */
.mw-custom { max-width: 40rem }
...
/* .hover-shadow-5:hover) { box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2) } */
.hover-bw2:hover,
.hover-bw2:active {
